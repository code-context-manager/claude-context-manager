...
export function PlaybookPage() {
  ...
  return (
    <div className="flex-1 flex overflow-hidden min-w-0">
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        <div className="px-6 py-4 border-b border-edge">
          <div className="flex items-start justify-between gap-4">
            <div>
              <h1 className="text-sm font-medium text-content-primary">Playbook</h1>
              <p className="text-xs text-content-muted mt-0.5">
                Things you can adopt to make Claude work better with your repo. Curated from the
                community-edited{' '}
                <span className="font-mono">claude-context-playbook</span> repo.
              </p>
            </div>
            <button
                ...
                <li key={entry.id}>
                  ...
                  >
                    <div className="flex items-baseline gap-2">
                      <h2 className="text-sm font-medium text-content-primary">{entry.title}</h2>
      ...
      <aside className="w-[420px] shrink-0 border-l border-edge overflow-y-auto bg-surface-sidebar">
        {selected ? (
